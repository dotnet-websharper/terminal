...
(function(){"use strict";var a,b,c,d,e;a=window.WebSharperTerminalSample=window.WebSharperTerminalSample||{};b=a.Client=a.Client||{};c=window.StartupCode$WebSharperTerminalSample$Client=window.StartupCode$WebSharperTerminalSample$Client||{};d=window.IntelliFactory;e=d&&d.Runtime;b.Main=function(){c.$cctor();return c.Main;};b.i=function(){c.$cctor();return c.i;};b.Opt=function(){c.$cctor();return c.Opt;};c.$cctor=e.Cctor(function(){var f,g,h,i;c.EO=(f={},f.raw=true,f);c.a=window.jQuery("body");c.i=function(j){return j==="help"?this.echo("Help command"):j==="clear"?this.clear():j==="template"?this.echo("Template command"):this.echo("command not found :(");};c.Opt=(g={},g.name="Terminal1",g.prompt=">",g.greetings="Welcome to the Terminal Test Page! See 'help' for the list of commands.",g);c.Main=(h=b.i(),(i=b.Opt(),void window.$("#body").terminal(h,i)));c.$cctor=window.ignore;});e.OnLoad(function(){b.Main();});}());
